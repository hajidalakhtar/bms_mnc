...
function Content() {
  ...
  const [id1119, set1119] = useState("");
  
  
  

function postData() {
  axios.post('https://hris.mncplay.id/property/api/bms/post/2/minggu', {
    id1118:id1118,
    id1119:id1119,
    ...
    >
      <FormControl isRequired>
        <Stack mx="4">
          ...
          <FormControl.Label mt="2" >Pest & Rodent Control (Indoor) - Spray</FormControl.Label>
                <Select
          minWidth="200"
        ...
        <FormControl.Label mt="2" >Pest & Rodent Control (Outdoor) - Pengasapan</FormControl.Label>
          <Select
          minWidth="200"
          placeholder="Keterangan"
          mt="1"
